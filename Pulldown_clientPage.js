class Pulldown_clientPage extends Pulldown {
    ...
    assemble() {
        ...
        const wrapped_pulldown_menu = this.wrap(PULLDOWN_MENU_CLASSNAME, pulldown_menu);
        ...
        const toggleMenu = function() {
            wrapped_pulldown_menu.style.display = (wrapped_pulldown_menu.style.display === "block") ? "none" : "block";
        }
        /* プルダウン出現のイベント付与 */
